...
def train():
    total_epochs = 100
    notifier = TrainingNotifier("Traffic Signs Model", total_epochs)
    ...
    results = model.train(
        data='/home/deploy/road-analysis/traffic_signs_augmented/data.yaml',
        epochs=total_epochs,
        imgsz=640,
        batch=32,
        workers=16,
    ...
    print(f"\n✅ Traffic signs model done! Best: {model.trainer.best}")
