...
def train():
    total_epochs = 100
    notifier = TrainingNotifier("Speed Bump Model", total_epochs)
    ...
    results = model.train(
        data='/home/deploy/road-analysis/speed_bump.yaml',
        epochs=total_epochs,
        imgsz=640,
        batch=16,
        workers=8,
    ...
    print(f"\n✅ Speed bump model done! Best: {model.trainer.best}")
